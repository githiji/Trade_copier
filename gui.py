...
class AccountManager:
    def __init__(self, root):
        ...
        self.login_entry = self.create_entry("Login")
        self.server_entry = self.create_entry("Server")
        self.password_entry = self.create_entry("Password", show="*")
        self.path_entry = self.create_entry("Terminal Path")

        path_buttons = ttk.Frame(root)
        path_buttons.pack(fill="x", padx=10, pady=(0, 8))
        ...
        ttk.Button(path_buttons, text="Add Account", command=self.add_account).pack(
            side="right",
            expand=True,
            fill="x",
            padx=(4, 0),
        ...
        self.account_table.pack(fill="both", expand=True, padx=10, pady=(0, 8))
        ...
        ttk.Button(action_row, text="Remove Selected", command=self.remove_selected).pack(
            side="right",
            expand=True,
            fill="x",
            padx=(4, 0),
